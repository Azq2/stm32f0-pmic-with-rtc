...
namespace Pinout {
	...
	constexpr uint32_t ADC_CH_TEMP		= 5;
	...
	constexpr const Pin BAT_TEMP		= {GPIOA, GPIO5};
	constexpr const Pin BAT_TEMP_EN		= {GPIOF, GPIO1};
	...
	constexpr const Pin BUZZER_PWM		= {GPIOA, GPIO4};
};
